/**
 * Credits: https://github.com/tur-nr/polymer-redux/blob/master/src/index.js
 * This file is adaptation from (https://github.com/tur-nr/polymer-redux/blob/master/src/index.js)
 * It is changed for Polymer-3, using separate path function rather than Polymer.path
 */
// Expose globals
const {CustomEvent, Polymer} = window;

import {get as pathGet} from '@polymer/polymer/lib/utils/path.js';
 ...
 */
export function PolymerRedux(store) {
	if (!store) {
